...
public class StudentFinanceService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(StudentFinanceService.class);

    @Autowired
    StudentFinanceRepository financeiroAlunoRepository;

    @Autowired
    InvoiceRepository faturaRepository;
    ...
    public void faturaGeneration() {
        ...
        List<StudentFinance> financeiroAlunos = financeiroAlunoRepository.findAll();

        for (StudentFinance financeiroAluno : financeiroAlunos) {
